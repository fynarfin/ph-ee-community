...
public class BillPaymentsController implements BillPaymentsApi {
    ...
    @Override
    public ResponseEntity<BillInquiryResponseDTO> billPayments(String tenantId, String correlationId, String callbackURL,
                                                               String payerFspId, BillPaymentsReqDTO body) throws ExecutionException {
